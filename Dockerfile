...
RUN wget https://github.com/wez/atomicparsley/releases/download/20210124.204813.840499f/AtomicParsleyAlpine.zip && unzip AtomicParsleyAlpine.zip && chmod +x AtomicParsley && rm AtomicParsleyAlpine.zip
